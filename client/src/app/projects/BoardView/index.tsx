...
const BoardView = ({ id, setIsModalNewTaskOpen }: Props) => {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div className="grid grid-cols-1 gap-4 p-4 md:grind-cols-2 xl:grid-cols-4">
      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
          <h3 className="flex items-center text-lg font-semibold dark:text-white">
            ...
            <span
              className="ml-2 flex items-center justify-center rounded-full bg-gray-200 text-center text-sm leading-none dark:dark-tertiary self-center"
